...
void SpectrumAnalyzer::drawCrossovers(juce::Graphics &g, juce::Rectangle<int> bounds)
{
    ...
    g.fillRect(Rectangle<int>::leftTopRightBottom(left,
                                                  zeroDb,
                                                  lowMidX,
                                                  mapY(lowBandGR)));
    g.fillRect(Rectangle<int>::leftTopRightBottom(lowMidX,
                                                  zeroDb,
                                                  midHighX,
                                                  mapY(midBandGR)));
    g.fillRect(Rectangle<int>::leftTopRightBottom(midHighX,
                                                  zeroDb,
                                                  right,
                                                  mapY(highBandGR)));
